...
exports.STYLE_PROPERTIES = void 0;
exports.STYLE_PROPERTIES = {
    properties: {
        ...
        borderColor: {
            values: ['inherit'],
            type: 'color',
            description: "A shorthand property for setting the color of the four sides of an element's border: border-top-color, border-right-color, border-bottom-color, border-left-color",
        },
        borderWidth: {
        ...
        overflow: {
            ...
            description: 'Specifies whether to clip content, show scrollbars, or display overflowing content when it is too large for its block-level container.',
        },
        overflowX: {
            values: ['auto', 'hidden', 'scroll', 'visible', 'inherit'],
        ...
        filter: {
            ...
            description: 'Lets you apply graphical effects like blurring, sharpening, or color shifting to an element.',
        },
        transformOrigin: {
        ...
        counterIncrement: {
            values: ['none', 'inherit'],
            description: 'Increases or decreases the value of a CSS counter by a given amount.',
        },
        counterReset: {
            values: ['none', 'inherit'],
        ...
        emptyCells: {
            ...
            description: 'Specifies how user agents should render borders and backgrounds around table cells that have no visible content.',
        },
        captionSide: {
        ...
        textDecorationColor: {
            values: [],
            type: 'color',
            description: 'Sets the color of the lines specified by text-decoration-line.',
        },
        textDecorationStyle: {
        ...
        boxDecorationBreak: {
            values: ['clone', 'slice'],
            description: 'Specifies how the background, padding, border, border-image, box-shadow, margin, and clip-path of an element is applied when the box for the element is fragmented.',
        },
        breakAfter: {
            values: [
                'always',
